package cz.davidkuna.remotecontrolclient.adapters;
...
import cz.davidkuna.remotecontrolclient.activity.WebRTCActivity;
import cz.davidkuna.remotecontrolclient.helpers.ChatUser;
import cz.davidkuna.remotecontrolclient.helpers.Constants;
import cz.davidkuna.remotecontrolclient.helpers.HistoryItem;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.callBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((WebRTCActivity)context).dispatchCall(hItem.getUser().getUserId());
            }
        });
