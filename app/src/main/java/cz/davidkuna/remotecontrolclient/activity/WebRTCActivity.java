...
import cz.davidkuna.remotecontrolclient.adapters.HistoryAdapter;
...
public class WebRTCActivity extends AppCompatActivity {
    ...
    private void dispatchIncomingCall(String userId) {
        ...
        Intent intent = new Intent(WebRTCActivity.this, IncomingCallActivity.class);
        intent.putExtra(Constants.USER_NAME, username);
    ...
    private void showToast(final String message) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(WebRTCActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        });
    }
